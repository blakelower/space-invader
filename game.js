...
var ALIEN_SQUAD_WIDTH = 11 * ALIEN_X_MARGIN;
  ...
  (function() {
    ...
    // Create a new Class that inherits fr om this class
...
//     function pause() {
//     var pause = swal("You paused the game, click 'OK' to continue your game and the other button to go to options"); 
